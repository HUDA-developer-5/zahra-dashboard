...
@section('content')
    ...
    <script>
        function onSubmit(token) {
            document.getElementById("CaptchaLoginForm").submit();
        }
    </script>
    <div class="row justify-content-center align-items-center min-vh-100">
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card p-2">
                <div class="card-body">
                    <form class="col-md-12 p-t-10" id="CaptchaLoginForm" role="form" method="POST" action="{{ route('backpack.auth.login') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group mb-0">
                            <div class="d-grid">
                                <button type="submit" class="btn btn-block btn-primary g-recaptcha"
                                        data-sitekey="{{ config('services.google.recaptcha.site_key') }}"
