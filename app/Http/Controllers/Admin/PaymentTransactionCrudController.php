...
class PaymentTransactionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\PaymentTransaction::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/payment-transaction');
        CRUD::setEntityNameStrings('payment transaction', 'payment transactions');
    }
