...
class WalletTransactionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\WalletTransaction::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/wallet-transaction');
        CRUD::setEntityNameStrings('wallet transaction', 'wallet transactions');
    }
    ...
    {
        CRUD::setValidation(WalletTransactionRequest::class);
